...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var food = JSON.parse(btn.dataset.foods);
    updateCart(food);
  });
...
socket.on('orderUpdated', function (data) {
  ...
  updatedOrder.updateAt = moment__WEBPACK_IMPORTED_MODULE_3___default()().format();
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkfoodDelivery"] = self["webpackChunkfoodDelivery"] || [];
